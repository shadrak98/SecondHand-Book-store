...
public class bought extends javax.swing.JFrame {
    ...
    String q = "select * from BOOKS_HISTORY WHERE B_ID IN (SELECT B_ID FROM BOOKS_HISTORY_R WHERE SELLER = ?)";
   System.out.println(name);
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(715, 526));
        ...
        jButton1.setBounds(55, 42, 77, 30);
        ...
        jScrollPane1.setBounds(160, 70, 452, 402);
